...
import { calculateMortgage, calculateSinkingFund, calculateHomeOwnerRealism, generateTimelineEvents } from '../lib/homeOwnerLogic';
...
describe('Home Owner Realist Logic', () => {
    ...
    describe('calculateSinkingFund', () => {
        it('should calculate monthly saving for future repairs', () => {
            const items = [
                { name: 'Roof', replacementCost: 12000, lifespanYears: 20, currentAgeYears: 15 }
            ];
        ...
        it('should handle expired items as immediate liability, not monthly cost', () => {
            const items = [
                { name: 'Dead HVAC', replacementCost: 8000, lifespanYears: 15, currentAgeYears: 20 }
            ];
    ...
    describe('generateTimelineEvents', () => {
        it('should predict future failures', () => {
            const items = [
                { name: 'Heater', replacementCost: 5000, lifespanYears: 10, currentAgeYears: 8 }
            ];
            // Remaining: 2 years. 
            // Fails at Year 2.
        ...
        it('should handle immediate failures', () => {
            const items = [
                { name: 'Dead Thing', replacementCost: 1000, lifespanYears: 5, currentAgeYears: 10 }
            ];
