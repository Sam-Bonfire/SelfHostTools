    ...
    <div className="min-h-screen bg-white text-black p-4 md:p-8 font-outfit">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-black hover:bg-yellow-300 px-3 py-1 border-2 border-transparent hover:border-black transition-all mb-4 font-bold"
          >
          ...
          <div className="p-6 bg-purple-400 border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tight">Feedback & Ideas</h1>
              <p className="font-bold text-lg md:text-xl mt-1 opacity-90">Tell us what to build next.</p>
            </div>
          </div>
        </div>
            ...
            {import.meta.env.VITE_NOTION_FORM_URL ? (
              ...
              <div className="max-w-md text-center">
                ...
                <p className="mb-6 font-medium">
                  Please add your Notion Form URL to the{' '}
                  <code className="bg-yellow-200 px-2 py-1 font-mono text-sm">VITE_NOTION_FORM_URL</code> environment
                  variable in your <code className="bg-yellow-200 px-2 py-1 font-mono text-sm">.env.local</code> file.
                </p>
