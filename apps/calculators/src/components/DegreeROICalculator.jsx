                ...
                <header className="mb-8 flex justify-between items-center bg-yellow-300 p-4 border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
                    <div className="flex items-center gap-4">
                        <Tooltip content="Return to Hub" position="right">
                            <Link to="/" aria-label="Back" className="p-2 bg-white text-black border-4 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none transition-all block">
                                <ArrowLeft className="w-5 h-5 text-black" />
                            </Link>
                        </Tooltip>
                        <h1 className="text-2xl md:text-3xl font-black text-black flex items-center gap-3 italic uppercase">
                            <GraduationCap className="w-8 h-8" /> Degree ROI Analyzer
                        </h1>
                    </div>
                </header>
