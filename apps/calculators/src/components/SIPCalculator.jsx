      ...
      <div className="max-w-6xl mx-auto">
        ...
        <header className="mb-8 flex justify-between items-center bg-yellow-300 p-4 border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
          <div className="flex items-center gap-4">
            <Tooltip content="Return to the main Calculators Hub" position="right">
              <Link to="/" aria-label="Back to Calculators Hub" className="p-2 bg-white border-4 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-[1px] hover:translate-y-[1px] hover:shadow-none transition-all active:translate-x-[2px] active:translate-y-[2px] block">
                <ArrowLeft className="w-5 h-5 text-black" />
              </Link>
            </Tooltip>
            <div className="text-center md:text-left">
              <h1 className="text-2xl md:text-3xl font-black text-black flex items-center gap-3 italic">
          ...
          <div className="lg:col-span-7 space-y-6">
            <Card className="h-full flex flex-col">
              <div className="p-4 bg-yellow-100 border-b-4 border-black">
                <h2 className="text-lg font-bold">Results Analysis</h2>
              </div>
