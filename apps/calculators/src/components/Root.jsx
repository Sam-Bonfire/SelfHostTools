                ...
                {categories.map((cat) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex-shrink-0 px-4 py-2 text-xs md:text-sm font-black uppercase border-2 border-black transition-all ${colorClass} text-black ${
                        isActive
                ...
                <Link to={calc.path} className="group block h-full decoration-transparent">
                  <Card className="h-full hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all duration-200 cursor-pointer flex flex-col">
                    <div className={`${calc.color} p-6 border-b-4 border-black flex items-center justify-between`}>
                      ...
                      <ArrowRight
                        className={`w-6 h-6 opacity-0 group-hover:opacity-100 transition-opacity transform group-hover:translate-x-1 ${calc.iconColor || 'text-black'}`}
                      />
                    </div>
                    <div className="p-6 flex-1 flex flex-col">
                      ...
                      <p className="text-gray-700 font-medium mb-6 flex-1">{calc.desc}</p>
