...
export default function TDEECalculator() {
  const structuredData = {
    ...
    description:
      'Calculate Total Daily Energy Expenditure (TDEE) and BMR. Includes Katch-McArdle formula for athletes.',
  ...
  const checkExports = (type) => {
    ...
    const data = {
      inputs: {
        ...formData,
        activityLevelLabel:
          ACTIVITY_LEVELS.find((l) => l.value == formData.activityLevel)?.label || formData.activityLevel
      },
      results: {
        ...results,
        ...macroResults
      ...
      <CalculatorLayout>
        <div className="lg:col-span-12">
          <CalculatorHeader
            ...
            onReset={() => {
              resetPersistedState('TDEECalculator');
            }}
          />
        </div>
            ...
            <div className="space-y-5">
              ...
              {!formData.useBodyFat && (
                <div className="space-y-1" role="group" aria-label="Gender Selection">
                  <label id="gender-label" className="block text-[10px] font-black uppercase mb-1">
                    Gender
                  </label>
            ...
            <div className="space-y-4">
                ...
                title={
                  <div className="flex-1">
                    ...
                    <p className="text-[10px] text-gray-500 font-bold leading-tight">
                      Use Katch-McArdle formula (More accurate for muscular/lean builds)
                    </p>
                  </div>
                }
              ...
              <div>
                ...
                <p className="text-[10px] font-bold text-gray-400 mt-2 uppercase leading-tight">
                  <span className="text-red-500 font-black">Warning: </span> Almost everyone overestimates this. If you
                  have a desk job, you are likely Sedentary or Lightly Active, even with gym time.
                </p>
              </div>
                ...
                <div className="space-y-3 pt-2 border-t-2 border-black/10 animate-in fade-in slide-in-from-top-1">
                    ...
                    <Tooltip content="Protein is automatically calculated based on the remaining allocation from Fats and Carbs to ensure 100% total.">
                      <div className="group cursor-help">
                        <div className="flex justify-between text-[10px] font-black uppercase mb-1 items-center">
                          <label
                            htmlFor="custom-macro-protein"
                            className="text-blue-600 flex items-center gap-1 border-b border-dashed border-blue-400 cursor-help"
                          >
                            Protein
                          </label>
                  ...
                  <div>
                    <div className="flex justify-between text-[10px] font-black uppercase mb-1">
                      <label htmlFor="custom-macro-fat" className="text-yellow-600">
                        Fats
                      </label>
                  ...
                  <div>
                    <div className="flex justify-between text-[10px] font-black uppercase mb-1">
                      <label htmlFor="custom-macro-carbs" className="text-green-600">
                        Carbs
                      </label>
          ...
          <Card title="How It Works" icon={Info} headerColor="bg-yellow-50">
            <div className="text-sm space-y-2 text-black">
              <p className="text-xs font-medium leading-relaxed">
                We use the <strong>Mifflin-St Jeor</strong> equation by default, which is the gold standard for
          ...
          <ResultsAnalysis title="Energy & Macros">
            ...
            <div className="bg-black text-[#FFDE59] p-6 border-4 border-black shadow-[8px_8px_0px_0px_rgba(255,222,89,0.5)] flex flex-col items-center justify-center gap-2 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                <p className="text-xs font-black uppercase tracking-[0.2em] mb-2 text-white/80">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] flex flex-col">
                <div className="bg-green-50 border-b-4 border-black p-3 flex justify-between items-center">
                  ...
                  <span className="text-[10px] font-black bg-green-200 px-2 py-1 border border-black rounded">
                    +500
                  </span>
                </div>
                <div className="p-4 text-center">
                  ...
                  <div className="max-h-60 overflow-y-auto">
                    <table className="w-full text-xs text-left">
                      ...
                      <tbody className="divide-y divide-gray-200">
                        {Array.from({ length: Math.min(results.weeksToGoal, 104) }).map((_, i) => {
                          // Cap visual at 2 years
                          const weekNum = i + 1;
                          ...
                          return (
                            <tr key={i} className="hover:bg-yellow-50 transition-colors">
                              <td className="p-3 font-black border-r-2 border-dashed border-gray-200">
                                Week {weekNum}
                              </td>
                              <td className="p-3 font-medium text-gray-500">
                                {date.toLocaleDateString(undefined, { month: 'short', day: 'numeric' })}
                              </td>
                              <td className="p-3 font-black bg-white">
                                {currentWeight.toFixed(1)}{' '}
                                <span className="text-[10px] bg-black text-white px-1 py-0.5 rounded ml-1">
                                  {formData.weightUnit}
                                </span>
                              </td>
            ...
            <div className="bg-gray-100 border-4 border-black p-4 text-center">
              <p className="text-xs font-bold text-gray-500 uppercase">
                ...
                <span className="text-black font-black text-lg mx-1 underline decoration-4 decoration-yellow-400">
