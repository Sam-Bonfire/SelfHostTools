...
import { Button, CalculatorHeader, CalculatorLayout, Card, Footer, Select } from '@packages/styling';
    ...
    <div className="min-h-screen bg-white text-black font-sans p-4 md:p-8">
      ...
      <CalculatorLayout>
        <div className="lg:col-span-12">
          <CalculatorHeader
            ...
            onReset={() => {
              resetPersistedState('SortingVisualizer');
            }}
          />
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-end">
              ...
              <div className="flex gap-2 h-full items-end">
                <Button
                  onClick={handleReset}
                  variant="outline"
                  className="flex-1 flex items-center justify-center gap-2 border-4 border-black font-bold"
                >
                  <RotateCcw size={20} />
                  RESET
                </Button>
      ...
      <Footer>
        <p className="text-gray-600 font-medium">
          ...
          The audible difference between Bubble Sort and Quick Sort demonstrates why algorithm choice
          matters—inefficiency compounds exponentially at scale.
        </p>
      </Footer>
    </div>
  );
