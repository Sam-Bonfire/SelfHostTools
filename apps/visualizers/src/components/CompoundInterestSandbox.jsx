                    ...
                    <ResultsAnalysis>
                        ...
                        <Card className="relative overflow-hidden p-0">
                            ...
                            <div className="bg-white p-4">
                                <canvas
                                    ref={canvasRef}
                                    className="w-full bg-white block border-2 border-dashed border-gray-300"
                                />
                            </div>
                        </Card>
                        ...
                        <Card className="p-4 bg-gray-50">
                            <div className="flex flex-wrap items-center gap-6 text-xs font-black uppercase">
                                ...
                                <span className="flex items-center gap-1.5">
                                    <span className="w-4 h-4 rounded-full bg-blue-500 border-2 border-black inline-block"></span>
                                    1 Coin = ₹{coinValue.toLocaleString('en-IN')} (Contribution)
                                </span>
                                <span className="flex items-center gap-1.5">
                                    <span className="w-4 h-4 rounded-full bg-yellow-400 border-2 border-black inline-block"></span>
                                    1 Coin = ₹{coinValue.toLocaleString('en-IN')} (Interest)
                                </span>
                                <span className="text-[9px] text-gray-400 font-bold">
                                    Total coins: {Math.max(2, Math.floor(latestYearData.contributions / coinValue)) + Math.max(1, Math.floor(latestYearData.interest / coinValue))}
                                </span>
                            </div>
                        </Card>
                    </ResultsAnalysis>
