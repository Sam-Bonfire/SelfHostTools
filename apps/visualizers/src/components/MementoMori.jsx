    ...
    <div className="min-h-screen bg-white text-black p-4 md:p-8 font-sans">
      ...
      <CalculatorLayout>
        <div className="lg:col-span-12">
          <CalculatorHeader
            ...
            onReset={() => {
              resetPersistedState('MementoMori');
            }}
          />
        </div>
        ...
        <div className="lg:col-span-12 xl:col-span-8">
          ...
          <div className="sr-only" role="status" aria-live="polite">
            You have lived {weeksData.stats.weeksPassed} weeks, which is {weeksData.stats.percentPassed}% of your
            estimated {lifeExpectancy} years.
          </div>
            ...
            <Card
              ...
              action={
                <span className="text-xs font-mono font-bold text-white">
                  {weeksData.stats.percentPassed}% COMPLETE
                </span>
              }
      ...
      <Footer>
        <p className="text-gray-600 font-medium">
          <strong>Disclaimer:</strong> This calendar is a Stoic visualization, not a literal prediction of your
          lifespan.
          <br className="md:hidden" />
          By confronting the finiteness of time—especially after subtracting sleep and obligations—you can prioritize
          what truly matters.
        </p>
      </Footer>
    </div>
