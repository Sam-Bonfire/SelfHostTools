    ...
    <div className="min-h-screen bg-white text-black p-4 md:p-8 font-sans">
      ...
      <CalculatorLayout>
        <div className="lg:col-span-12">
          <CalculatorHeader
            namespace="RunwayHorizon"
            icon={Sun}
            title="Personal Runway Horizon"

            onReset={() => {
              resetPersistedState('RunwayHorizon');
            }}
          />
        </div>
        ...
        <div className="lg:col-span-12 xl:col-span-8 space-y-6">
          <ResultsAnalysis>
            <div ref={resultsRef} className="space-y-6">
              ...
              <Card
                title="Life Event Stress-Test (Click to Inject)"
              ...
              <Card
                title="24-Month Rolling Horizon"
                headerColor="bg-black text-white"
                className="relative overflow-hidden"
              >
                    ...
                    <svg viewBox="0 0 600 300" className="w-full h-auto block overflow-visible select-none">
                        ...
                        return (
                          <g key={ev.id} className="transition-all duration-300">
                            ...
                            <circle
                              ...
                              cy={pt.y}
                              r="5"
                              fill={ev.amount < 0 ? '#EF4444' : '#10B981'}
                              stroke="#000"
                              strokeWidth="2.5"
                            />
                      ...
                      {crashPointX !== null && crashPointX < 580 && (
                        <g>
                          ...
                          />
                          {/* Alert Skull flag */}
                          <line x1={crashPointX} y1="260" x2={crashPointX} y2="50" stroke="#EF4444" strokeWidth="3" />
                      ...
                      <g fill="#6B7280" fontSize="9" fontWeight="900" className="uppercase">
                        <text x="20" y="278" textAnchor="middle">
                          Today
                        </text>
                        <text x="160" y="278" textAnchor="middle">
                          Month 6
                        </text>
                        <text x="300" y="278" textAnchor="middle">
                          Month 12
                        </text>
                        <text x="440" y="278" textAnchor="middle">
                          Month 18
                        </text>
                        <text x="580" y="278" textAnchor="middle">
                          Month 24
                        </text>
                      </g>
                    </svg>
      ...
      <Footer>
        <p className="text-gray-600 font-medium">
          ...
          The true lesson is elasticity—your survival runway is always longer than your comfort runway if you are
          willing to cut variable burn drastically.
        </p>
      </Footer>
    </div>
  );
