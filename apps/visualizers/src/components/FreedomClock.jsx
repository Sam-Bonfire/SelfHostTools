    ...
    const qualitativeFeedback = useMemo(() => {
        ...
        if (idx < 10) {
            return {
                ...
                description: "Extreme danger of mental fatigue, high stress, and absolute burnout. Your overhead drag is too high. Consider outsourcing chores or automating admin tasks immediately.",
                icon: ShieldAlert
            };
        } else if (idx < 25) {
            return {
                ...
                title: "Survival Mode ⚡",
                description: "Decent daily baseline, but overhead drag restricts genuine growth, health routines, and personal creative freedom. Seek ways to buy back 1–2 hours.",
                icon: Coffee
            };
        } else {
            return {
                ...
                description: "Excellent life balance! You have abundant margin to dedicate to upskilling, fitness, reading, and high-value side ventures.",
                icon: Sparkles
            };
        }
                            ...
                            <div className="flex flex-col md:flex-row gap-8 items-center justify-around">
                                ...
                                <svg width="300" height="300" className="block select-none overflow-visible w-full max-w-[280px]">
                                    <g>
                                        ...
                                        <text x="150" y="146" textAnchor="middle" fill="#000000" fontSize="10" fontWeight="900" className="uppercase tracking-widest">
                                            Freedom
                                        </text>
                                        <text x="150" y="165" textAnchor="middle" fill="#000000" fontSize="18" fontWeight="900" className="font-mono">
                                            {timeBreakdown.freedomIndex}%
                                        </text>
                                    </g>
                                </svg>
