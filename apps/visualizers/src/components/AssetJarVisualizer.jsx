...
import { CalculatorHeader, CalculatorLayout, Card, Footer } from '@packages/styling';
import { PackageOpen, RefreshCw, Settings2, Zap } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#f8f9fa] text-black p-4 md:p-8 font-['Outfit']">
      ...
      <CalculatorLayout>
        <div className="lg:col-span-12">
          <CalculatorHeader
            namespace="AssetJarVisualizer"
            icon={PackageOpen}
            title="Asset Allocation Jar"

            onReset={() => {
              resetPersistedState('AssetJarVisualizer');
            }}
          />
        </div>
        ...
        <div className="lg:col-span-12 flex flex-col md:flex-row gap-12 bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rounded-xl p-8">
          <div className="flex-1 flex flex-col items-center justify-end h-[500px]">
            ...
            <div className="mt-6 font-black text-2xl tracking-tight text-black uppercase border-b-4 border-black pb-1">
              The Density Jar
            </div>
          </div>
                ...
                {Object.entries(assets).map(([key, asset]) => (
                  <div key={key}>
                    <div className="flex justify-between font-bold mb-2 text-lg">
                      <span
                        className="uppercase tracking-tight bg-white px-2 py-0.5 border-2 border-black rounded shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
