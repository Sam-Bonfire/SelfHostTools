...
import { Button, CalculatorHeader, CalculatorLayout, Footer } from '@packages/styling';
    ...
    <div className="min-h-screen bg-[#FFFDF9] text-black p-4 sm:p-8 font-outfit relative overflow-hidden">
      ...
      <CalculatorLayout>
        <div className="lg:col-span-12">
          <CalculatorHeader
            namespace="PomodoroFocusVisualizer"
            icon={Activity}
            title="Pomodoro Focus"

            onReset={() => {
              resetPersistedState('PomodoroFocusVisualizer');
            }}
          />
        </div>
      ...
      <Footer>
        <p className="text-gray-600 font-medium">
          ...
          By committing to short, unbroken intervals of focus, you overcome the friction of starting and build deep
          momentum.
        </p>
      </Footer>
    </div>
