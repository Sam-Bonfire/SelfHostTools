  ...
  return (
    <div className="mt-8 border-4 border-black bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative">
      ...
      <div className="h-2 bg-gray-200 w-full border-b-4 border-black">
        <div className="h-full bg-green-400 transition-all duration-500 ease-out" style={{ width: `${progress}%` }} />
      </div>
        ...
        {actions.map((action, index) => {
          ...
          return (
            ...
            >
              ...
              <div>
                <h4
                  className={`font-bold text-base sm:text-lg ${isCompleted ? 'line-through text-gray-500' : 'text-black'}`}
                >
                  {action.title}
                </h4>
