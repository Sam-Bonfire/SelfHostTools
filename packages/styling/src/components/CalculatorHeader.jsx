...
const CalculatorHeader = ({
  ...
  return (
    <header
      className={`flex flex-col sm:flex-row justify-between items-stretch sm:items-center ${color} p-4 border-4 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-black gap-4`}
    >
      <div className="flex items-center gap-4 w-full sm:w-auto">
        ...
        <div>
          ...
          {(subtitle || description) && <p className="text-sm font-bold mt-1 opacity-80">{subtitle || description}</p>}
        </div>
      </div>
