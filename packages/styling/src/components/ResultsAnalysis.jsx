 ...
 */
const ResultsAnalysis = ({ children, title = "Results Analysis", className = "", headerElements, headerColor = "bg-[#FFDE59]" }) => {
    return (
        <Card className={`h-full flex flex-col ${className}`}>
            <div className={`p-4 border-b-4 border-black flex justify-between items-center text-black ${headerColor}`}>
